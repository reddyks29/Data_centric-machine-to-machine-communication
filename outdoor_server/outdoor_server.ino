...
const char* ssid = "This";  // Replace with your WiFi SSID
const char* password = "12345668";  // Replace with your WiFi password
IPAddress serverIP(192, 168, 72, 218);  // Raspberry Pi server IP address
